...
public class dashboardController implements Initializable {
    ...
    @FXML
    private TableView<Train> availableB_tableView;

    @FXML
    private TableColumn<Train, String> availableB_col_busID;

    @FXML
    private TableColumn<Train, String> availableB_col_location;

    @FXML
    private TableColumn<Train, String> availableB_col_status;

    @FXML
    private TableColumn<Train, String> availableB_col_price;

    @FXML
    private TableColumn<Train, String> availableB_col_date;
...
//            NOW LETS PROCEED TO BOOKING TICKET : ) 
    ...
    public ObservableList<Train> availableBusBusData() {

        ObservableList<Train> busListData = FXCollections.observableArrayList();
        ...
        try {
            ...
            while (result.next()) {
                busD = new Train(result.getInt("bus_id"),
    ...
    private ObservableList<Train> availableBBusListData;
    ...
    public void avaialbleBSelectBusData() {
        ...
        Train busD = availableB_tableView.getSelectionModel().getSelectedItem();
    ...
    public void availableSearch(){
        ...
        FilteredList<Train> filter = new FilteredList<>(availableBBusListData, e-> true);
...
//                    NOTE, IF INTEGER OR IF THE DATA TYPE IS NOT STRING, YOU MUST BE DO toString()
        ...
        SortedList<Train> sortList = new SortedList<>(filter);
